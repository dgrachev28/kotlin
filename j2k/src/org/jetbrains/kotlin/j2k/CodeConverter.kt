...
class CodeConverter(
    ...
    internal fun findAssignmentsAsExpressions(statement: PsiStatement?): Array<Expression> {
        return PsiTreeUtil.findChildrenOfType(statement, PsiAssignmentExpression::class.java)
